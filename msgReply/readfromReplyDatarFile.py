...
def read_json_file_line_by_line():
    ...
    logger.info("Reading ticket from parentMsgIds.json file - STARTED.")
    """
    ...
    logger.info("Reading ticket from parentMsgIds.json file - COMPLETED.")
    return data_list
...
if __name__ == '__main__':
    ...
    reminder_data_list = read_json_file_line_by_line()
